                        ...
                        <div class="container">
                            <div class="row g-4 justify-content-between">
                                <div class="col-md-6 col-xl-5">
                                    <span class="badge bg-primary-emphasis hover:bg-primary-emphasis text-primary-subtle hover:text-primary-subtle mb-2">
                                ...
                                <div class="col-md-6">
                                    <div class="accordion accordion-separate-body" id="accordion-{{ Str::slug($category) }}">
