                            ...
                            <div class="banner-1__content">
                                <div class="row">
                                    <div class="col-md-8 col-xl-6">
                                        ...
                                        <h3>Blog</h3>
                                        <p class="mb-0 max-text-12">Insights, updates, and deep dives from the Cyberwatch360 team.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <ul class="list list-row flex-wrap gap-4 gap-xl-6 align-items-center mb-4">
                                                    <li>
                                                        <a href="{{ route('blog') }}" class="badge bg-light-subtle text-light-emphasis shadow-lg">
                                                            <span class="d-inline-block w-2 h-2 rounded-circle bg-secondary-emphasis flex-shrink-0"></span>
                                                            {{ $post->category }}
                                                        </a>
                                                    </li>
                                                    <li>
                                            ...
                                            @if(!empty($search))
                                                <div class="mt-2">
                                                    <a href="{{ route('blog') }}" class="fs-12 text-muted">
                                                        <iconify-icon icon="bi:x-circle"></iconify-icon> Clear search
                                                    </a>
                                                </div>
                                            @endif
                                        </form>
                                        ...
                                        <ul class="list gap-0">
                                            ...
                                            <li class="border-bottom py-3">
                                                <a href="{{ $category === $cat->category ? route('blog') : route('blog', ['category' => $cat->category]) }}"
                                                    ...
                                                    <span class="d-inline-flex align-items-center justify-content-center rounded-circle fw-medium fs-12 {{ $category === $cat->category ? 'bg-primary text-white' : 'bg-body-tertiary' }}"
                                        ...
                                        <ul class="list gap-8">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center gap-4">
                                                    <div class="d-grid place-content-center w-18 h-18 flex-shrink-0 rounded-circle overflow-hidden">
                                                        <img src="{{ $r->image_url }}" alt="image" class="w-100 h-100 object-fit-cover">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <span class="d-block fs-12 fw-medium mb-1">{{ $r->published_at?->format('d M, Y') }}</span>
                                        ...
                                        <ul class="list gap-0">
                                            ...
                                            <li class="border-bottom py-3">
                                                <a href="{{ route('blog', ['month' => $month->month_key]) }}"
                                                    ...
                                                    <span class="d-inline-flex align-items-center justify-content-center rounded-circle fw-medium fs-12 {{ request('month') === $month->month_key ? 'bg-primary text-white' : 'bg-body-tertiary' }}"
                                                        style="width:32px;height:32px;">
