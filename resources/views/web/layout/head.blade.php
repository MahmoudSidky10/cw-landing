<head>
    ...
    @php($faviconV = @filemtime(public_path('assets/img/favicon.png')) ?: time())
    <link rel="icon" href="{{ asset('assets/img/favicon.png') }}?v={{ $faviconV }}" type="image/png">
    <link rel="apple-touch-icon" href="{{ asset('assets/img/favicon.png') }}?v={{ $faviconV }}">
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/simplebar.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/swiper-bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/ff-1.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/ff-2.css') }}">
