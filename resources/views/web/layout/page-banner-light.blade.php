{{-- Expects: $bannerCrumb, $bannerTitle, $bannerLead --}}
            <div class="banner-1">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <nav class="mb-3">
                                            <ol class="breadcrumb breadcrumb-modifier">
                                                ...
                                                <li class="breadcrumb-item active fs-14" aria-current="page">{{ $bannerCrumb }}</li>
                                            </ol>
                                        </nav>
                                        <h3>{{ $bannerTitle }}</h3>
                                        <p class="mb-0 max-text-12">{{ $bannerLead }}</p>
                                    </div>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="1124" height="401"
                                    viewBox="0 0 1124 401" fill="none" class="banner-1__froster-svg">
                                    <g filter="url(#filter0_f_page_banner_light)">
                                        <path
                                    ...
                                    <defs>
                                        <filter id="filter0_f_page_banner_light" x="0.333405" y="-282.667" width="1182.33"
                                            ...
                                            <feGaussianBlur stdDeviation="133.333"
                                                result="effect1_foregroundBlur_page_banner_light" />
                                        </filter>
                                    </defs>
                                </svg>
                            </div>
