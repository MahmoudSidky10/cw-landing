            ...
            <footer class="position-relative z-1 overflow-hidden">
                                ...
                                <div class="pe-xxl-10">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-3 mb-6">
                                        <div class="d-flex align-items-center gap-2 py-3 px-2 rounded bg-body shadow">
                                            <img src="{{ asset('assets/img/certificate-img-1.png') }}" alt=""
                                        ...
                                        <div class="d-flex align-items-center gap-2 py-3 px-2 rounded bg-body shadow">
                                            <img src="{{ asset('assets/img/certificate-img-2.png') }}" alt=""
                                                class="img-fluid flex-shrink-0">
                                            <div class="flex-grow-1">
                                                <ul class="list list-row gap-1 align-items-center lh-1">
                                                    @for ($i = 0; $i < 5; $i++)
                                    ...
                                    <div class="d-flex justify-content-between align-items-center gap-4 py-2 px-4 bg-body rounded shadow">
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="{{ asset('assets/img/avatar-6.png') }}" alt=""
                                                class="img-fluid flex-shrink-0">
                                            <div class="flex-grow-1">
                                                <span class="d-block fw-medium fs-14">Questions? <a href="{{ route('contact') }}" class="text-primary text-decoration-none">Contact us</a></span>
                                            </div>
                                        </div>
                                        <a href="{{ route('contact') }}" class="link d-inline-block text-primary flex-shrink-0">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col-lg-6">
                                <ul class="list list-row list-dot list-dot--md list-dot--secondary-emphasis flex-wrap align-items-center justify-content-center justify-content-lg-start">
                                    ...
                                    <li><a href="{{ route('privacy-policy') }}" class="link d-inline-block text-body hover:text-primary fs-14">Privacy</a></li>
                                    <li><a href="{{ route('faq') }}" class="link d-inline-block text-body hover:text-primary fs-14">FAQ</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                ...
                <svg width="860" height="579" viewBox="0 0 860 579" fill="none"
                    ...
                    <g filter="url(#filter0_f_footer_light_5037)">
                        <path
                    ...
                    <defs>
                        <filter id="filter0_f_footer_light_5037" x="-216.362" y="-377.364" width="1076.05" height="993.048"
                            filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                            <feGaussianBlur stdDeviation="133.333" result="effect1_foregroundBlur_footer_light_5037" />
                        </filter>
                    </defs>
                </svg>
                <svg width="691" height="579" viewBox="0 0 691 579" fill="none"
                    ...
                    <g filter="url(#filter0_f_footer_light_5038)">
                        <path
                    ...
                    <defs>
                        <filter id="filter0_f_footer_light_5038" x="0.333405" y="-312.667" width="1119.59" height="933.333"
                            filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                            <feFlood flood-opacity="0" result="BackgroundImageFix" />
                            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                            <feGaussianBlur stdDeviation="133.333" result="effect1_foregroundBlur_footer_light_5038" />
                        </filter>
                    </defs>
                </svg>
            </footer>
